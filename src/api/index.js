...
export async function getTaskTypes() {
  const res = await fetch(`http://localhost:4000/task/type`);
...
export async function getTask(id_service, id_task) {
  const res = await fetch(`http://localhost:4000/getTask/${id_service}/${id_task}`);
  const data = await res.json();
  return data;
}
...
export async function getTeams(id_service) {
  const res = await fetch(`http://localhost:4000/task/teams/${id_service}/false`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function getOperators(id_service, id_team) {
  const res = await fetch(`http://localhost:4000/task/operatorsAvailable/${id_service}/${id_team}`, {
    method: "GET",
  });
  const data = await res.json();
  return data;
...
export async function getVehicles(id_service, id_team) {
  const res = await fetch(`http://localhost:4000/task/vehiclesAvailable/${id_service}/${id_team}`, {
    method: "GET",
  });
  const data = await res.json();
  return data;
